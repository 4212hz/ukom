                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="nama_pelanggan" class="form-control" value="<?= $d['nama_pelanggan']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>No. Telepon</label>
                                            <input type="text" required name="nomor_telepon" class="form-control" value="<?= $d['nomor_telepon']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input type="text" required name="alamat" class="form-control" value="<?= $d['alamat']; ?>">
                                        </div>
                                    </div>
