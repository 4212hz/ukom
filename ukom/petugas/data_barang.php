            ...
            <tbody>
                ...
                while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td><?= $d['stok']; ?></td>
                        <td>
                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?= $d['produk_id'] ?>" >
                                Edit
                            </button>
                                ...
                                <form action="proses_update_barang.php" method="post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="nama_produk" class="form-control" value="<?= $d['nama_produk']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Harga Produk</label>
                                            <input type="number" required name="harga" class="form-control" value="<?= $d['harga']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Stok Produk</label>
                                            <input type="number" required name="stok" class="form-control" value="<?= $d['stok']; ?>">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" require class="btn btn-primary">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
