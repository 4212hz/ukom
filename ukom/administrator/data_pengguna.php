                                ...
                                <form action="proses_update_petugas.php" method="post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="nama_petugas" class="form-control" value="<?= $d['nama_petugas']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input type="text" required name="username" class="form-control" value="<?= $d['username']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>password</label>
                                            <small class="text-danger text-sm">* Kosongkan Kalau Tidak Merubah Password</small>
                                            <input type="password" required name="password" class="form-control" value="<?= $d['password']; ?>">
                                        </div>
                                        <div class="form-group">
